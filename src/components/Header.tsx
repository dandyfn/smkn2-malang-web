      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-amber-500 border border-amber-600 flex items-center justify-center font-black text-slate-950 shadow-md group-hover:bg-slate-950 group-hover:text-amber-400 transition duration-300">
              N2
            </div>
          ...
          <nav className="hidden md:flex items-center gap-1 font-semibold text-sm">
            <a href="#" className="px-4 py-2 rounded-xl text-slate-700 hover:text-amber-600 hover:bg-slate-100 transition">
              Beranda
            </a>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full pt-2 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50 w-56">
                <div className="bg-white border border-slate-200 rounded-2xl p-2 shadow-xl ring-1 ring-black/5">
                  <a href="#profil" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-700 hover:text-amber-600 hover:bg-slate-50 hover:border-l-2 hover:border-amber-500 transition">
                    <span className="text-xs font-bold text-amber-600">01</span> Profil Singkat
                  </a>
                  <a href="#organisasi" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-700 hover:text-amber-600 hover:bg-slate-50 hover:border-l-2 hover:border-amber-500 transition">
